...
Original file is located at
    https://colab.research.google.com/drive/1VKw7I5vy-fZEcbNwXKhmNTLcqKcyta57
...
#        print('state shape in get_action', np.shape([state]))
    ...
    def update(self, state, action, target, sess=None):
        ...
        _, loss = sess.run([self.optimizer, self.loss], feed_dict=feed)
#        return loss
...
class ValuesEstimator():
    def __init__(self, learning_rate=0.01, scope='Values_Estimator'):
        ...
        self.optimizerV = tf.train.AdamOptimizer(learning_rate=learning_rate).minimize(self.lossV)
    ...
    def update(self, state, target, sess=None):
        ...
        _, lossV = sess.run([self.optimizerV, self.lossV], feed_dict=feed)
#        return lossV
...
with tf.Session() as sess:
    ...
    reinforce(env, policy_estimator, value_estimator, n_episodes=50, gamma=1.0)
